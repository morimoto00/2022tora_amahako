...
class ResultActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        when (gameResult) {
            0 -> binding.resultLavel.setText(R.string.result_draw)
            1 -> binding.resultLavel.setText(R.string.result_win)
            2 -> binding.resultLavel.setText(R.string.result_lose)
        }
    ...
    private fun saveData(myHand: Int, comHand: Int, gameResult: Int) {
        ...
        val winningStreakCount = pref.getInt("WINNING_SPEAK_COUNT", 0)
